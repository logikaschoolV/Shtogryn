...
class RegisterWindow(CTk):
    def __init__(self):
        ...
        self.host_entry = CTkEntry(self,placeholder_text="Введіть хост сервера(н, localhost)")
        self.host_entry.pack(pady = 5)
        self.port_entry = CTkEntry(self,placeholder_text="Введіть порт сервера (н 12334)")
    ...
    def start_chat(self):
        ...
        try:
            ...
            print(f"Не вдалося під'єднатися до сервера {e}")
...
class MainWindow(CTk):
    ...
    def add_message(self,message,img=None):
        ...
        if not img:
            CTkLabel(message_frame,text=message,wraplength=wrap_length,text_color="white",justify="left").pack(padx=10,pady=5)

        else:
            CTkLabel(message_frame,text=message,wraplength=wrap_length,text_color="white",image=img,compound="top",justify="left").pack(padx=10,pady=5)
